...
export default function Find() {
  ...
  return (
    <div className="h-300 flex w-full flex-col justify-center place-self-centertext-white">
      <form
        action=""
        className="no-wrap h-300 flex w-full flex-row justify-center place-self-center bg-green-900 py-20 text-white"
      >
        <input
          type="text"
